###########################################################################
## Makefile generated for Simulink model 'simulink_arduino_practice'. 
## 
## Makefile     : simulink_arduino_practice.mk
## Generated on : Thu Sep 24 13:40:09 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simulink_arduino_practice.elf
...
PRODUCT_NAME              = simulink_arduino_practice
MAKEFILE                  = simulink_arduino_practice.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/gdube/Documents/MATLAB/ece4950_proj_1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulink_arduino_practice.elf
...
DEFINES_ = -DMODEL=simulink_arduino_practice -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=simulink_arduino_practice -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_AnalogInput.o ArduinoPinHandleMap.o simulink_arduino_practice.o simulink_arduino_practice_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_arduino_practice.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/simulink_arduino_practice.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_arduino_practice_data.o : $(START_DIR)/simulink_arduino_practice_ert_rtw/simulink_arduino_practice_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
